...
const contractAddress = "0x37e5228D50Bf52ecc76EBACE920B0174bD1019E9";
const abi =[
	{
		"constant": false,
		"inputs": [
...
// inserting variables as parameters for function which is obtained from User Interface
	scholarshipContract.methods.enterIncome(address,income).send({ from: coinbaseAddress1, gas: 100000000 }).then(function (value12) {
    console.log(value12);
    res.send(value12);
  });
	
	// calling enterMarks function in smart contract and writting data to blockchain 
  scholarshipContract.methods.enterMarks(address,mark1,mark2,mark3).send({ from: coinbaseAddress1, gas: 100000000 }).then(function (value13) {
    console.log(value13);
    res.send(value13);
	});
	// calling register function in smart contract and writting data to blockchain
  scholarshipContract.methods.register(address,name,caste).send({ from: coinbaseAddress1, gas: 100000000 }).then(function (value11) {
    console.log(value11);
    res.send(value11);
	});
  ...
  scholarshipContract.methods.transfer(toAddress1,tokens1).send({ from: coinbaseAddress2, gas: 100000000 }).then(function (value14) {
    console.log(value14);
    res.send(value14);
	});
...
router.post('/transfer', function (req, res, next) {
  ...
  scholarshipContract.methods.transferFrom(fromAddress2,toAddress2,tokens2).send({ from: coinbaseAddress3, gas: 100000000 }).then(function (value15) {
    console.log(value15);
    res.send(value15);
	});
